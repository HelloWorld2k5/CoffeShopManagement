...
public class CartPanel extends JPanel implements Observer {
    ...
    private void initUI() {
        ...
        // --- 2. Ở GIỮA: DANH SÁCH MÓN ĐÃ ĐẶT TÙY BIẾN (SỬA LỖI TRÙNG MÀU HEADER CHỮ TRẮNG NỀN NÂU) ---
        ...
        // Tạo Custom Cell Renderer cho Header để chống bị Look & Feel mặc định của Windows ghi đè màu sắc
        tableHeader.setDefaultRenderer((table, value, isSelected, hasFocus, row, column) -> {
            ...
            headerLabel.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 1, COLOR_LATTE_LIGHT)); // Đường kẻ mảnh phân cột
            return headerLabel;
        });
   ...
   btnCheckout.addActionListener(e -> {
    ...
    // 3. Mở Dialog thanh toán (Modal = true giúp dừng luồng code tại đây cho đến khi đóng)
    ...
    private void loadTablesFromDatabase() {
        ...
        listTablesMemory.add(new TableItem(5, "Bàn số 05", "FREE"));
